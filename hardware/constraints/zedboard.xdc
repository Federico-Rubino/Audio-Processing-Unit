...
# Audio Codec - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN AB1 [get_ports {AC_ADR0_0}];  # "AC-ADR0"
set_property PACKAGE_PIN Y5  [get_ports {AC_ADR1_0}];  # "AC-ADR1"
set_property PACKAGE_PIN Y8  [get_ports {AC_GPIO0_0}];  # "AC-GPIO0"
set_property PACKAGE_PIN AA7 [get_ports {AC_GPIO1_0}];  # "AC-GPIO1"
set_property PACKAGE_PIN AA6 [get_ports {AC_GPIO2_0}];  # "AC-GPIO2"
set_property PACKAGE_PIN Y6  [get_ports {AC_GPIO3_0}];  # "AC-GPIO3"
set_property PACKAGE_PIN AB2 [get_ports {AC_MCLK_0}];  # "AC-MCLK"
set_property PACKAGE_PIN AB4 [get_ports {AC_SCK_0}];  # "AC-SCK"
set_property PACKAGE_PIN AB5 [get_ports {AC_SDA_0}];  # "AC-SDA"

# ----------------------------------------------------------------------------
# Clock Source - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y9 [get_ports {clk_in1_0}];  # "GCLK"
...
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W12 [get_ports {uart_rtl_0_rxd}];  # "JB1"
# set_property PACKAGE_PIN V8 [get_ports {JB10}];  # "JB10"
set_property PACKAGE_PIN W11 [get_ports {uart_rtl_0_txd}];  # "JB2"
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {gpio_rtl_1_tri_o[0]}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {gpio_rtl_1_tri_o[1]}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {gpio_rtl_1_tri_o[2]}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {gpio_rtl_1_tri_o[3]}];  # "LD3"
set_property PACKAGE_PIN V22 [get_ports {gpio_rtl_1_tri_o[4]}];  # "LD4"
set_property PACKAGE_PIN W22 [get_ports {gpio_rtl_1_tri_o[5]}];  # "LD5"
set_property PACKAGE_PIN U19 [get_ports {gpio_rtl_1_tri_o[6]}];  # "LD6"
set_property PACKAGE_PIN U14 [get_ports {gpio_rtl_1_tri_o[7]}];  # "LD7"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {reset_rtl_0}];  # "BTNC"
set_property PACKAGE_PIN R16 [get_ports {gpio_rtl_0_tri_i[8]}];  # "BTND"
set_property PACKAGE_PIN N15 [get_ports {gpio_rtl_0_tri_i[9]}];  # "BTNL"
set_property PACKAGE_PIN R18 [get_ports {gpio_rtl_0_tri_i[10]}];  # "BTNR"
set_property PACKAGE_PIN T18 [get_ports {gpio_rtl_0_tri_i[11]}];  # "BTNU"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {gpio_rtl_0_tri_i[0]}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {gpio_rtl_0_tri_i[1]}];  # "SW1"
set_property PACKAGE_PIN H22 [get_ports {gpio_rtl_0_tri_i[2]}];  # "SW2"
set_property PACKAGE_PIN F21 [get_ports {gpio_rtl_0_tri_i[3]}];  # "SW3"
set_property PACKAGE_PIN H19 [get_ports {gpio_rtl_0_tri_i[4]}];  # "SW4"
set_property PACKAGE_PIN H18 [get_ports {gpio_rtl_0_tri_i[5]}];  # "SW5"
set_property PACKAGE_PIN H17 [get_ports {gpio_rtl_0_tri_i[6]}];  # "SW6"
set_property PACKAGE_PIN M15 [get_ports {gpio_rtl_0_tri_i[7]}];  # "SW7"
