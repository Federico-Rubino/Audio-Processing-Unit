...
# 7. Add Testbenches & Simulation Assets (test/rv32i)
set sim_files [glob -nocomplain "$repo_root/test/rv32i/*.{v,vhd,sv}"]
...
set coe_files [glob -nocomplain "$repo_root/test/rv32i/coe/*.coe"]
